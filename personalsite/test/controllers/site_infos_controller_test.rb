...
class SiteInfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create site_info" do
    assert_difference('SiteInfo.count') do
      post site_infos_url, params: { site_info: { brand: @site_info.brand, heading: @site_info.heading, lead: @site_info.lead, subheading: @site_info.subheading } }
    end
  ...
  test "should update site_info" do
    patch site_info_url(@site_info), params: { site_info: { brand: @site_info.brand, heading: @site_info.heading, lead: @site_info.lead, subheading: @site_info.subheading } }
